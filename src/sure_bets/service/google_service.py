...
def agregar_fila_google_sheets(sheet_id, nombre_hoja, nueva_fila, credenciales_json='credentials.json'):
    ...
    nombre_hoja: Nombre de la pestaña/hoja
    nueva_fila: Diccionario con los datos a agregar (debe coincidir el orden con los encabezados)
    credenciales_json: Ruta al archivo de credenciales de Google Service Account
    """
